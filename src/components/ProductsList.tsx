  ...
  return (
    <Grid container component="section">
      <ProductItem url={galaxy01}>
        ...
        diam nec nibh. Proin sagittis leo nibh, et finibus erat sollicitudin et.
        Etiam vitae purus sit amet velit eleifend placerat sed eu libero. Nullam
        suscipit ex ante, ac ultrices magna iaculis ac. Vivamus aliquet ultrices
        bibendum. Ut pulvinar condimentum lacinia. Sed finibus ultrices neque.
        Phasellus massa magna, imperdiet a nisi ac, dapibus pulvinar libero.
        Pellentesque rhoncus nunc tortor, a aliquet enim eleifend ac. Cras
        volutpat eros non nibh congue pharetra. Donec vitae metus in eros tempor
        commodo. Suspendisse rutrum dui in orci eleifend, quis faucibus elit
        cursus.
      </ProductItem>
      <ProductItem url={galaxy02}>
        Phasellus eget quam risus. Proin ut aliquet felis, quis accumsan metus.
        Duis pretium at lacus id auctor. Quisque vel metus eget leo gravida
        semper non id purus. Phasellus elit lacus, imperdiet sed fermentum eget,
        feugiat quis elit. Morbi urna lacus, cursus at viverra id, eleifend vel
        velit. Praesent molestie at massa at maximus.
      </ProductItem>
      <ProductItem url={galaxy03}>
        ...
        feugiat dui. Duis vel luctus risus. Duis eleifend est id ex semper, non
        ullamcorper ligula mattis. Sed varius interdum lacus ac efficitur.
        ...
        Cras quam enim, blandit vitae tincidunt vitae, efficitur nec urna. Donec
        at magna dui.
      </ProductItem>
